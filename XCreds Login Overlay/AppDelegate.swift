...
class App {
    static func main() {
        if let ud = UserDefaults(suiteName: "ai.sgc.xcreds") {
 ...
 */
    func setupWindow()  {
        ...
        if let ud = UserDefaults(suiteName: "ai.sgc.xcreds"),  let customTextString = ud.value(forKey: "cloudLoginText") {
    ...
    func applicationDidFinishLaunching(_ aNotification: Notification) {
        ...
        UserDefaults.standard.addSuite(named: "ai.sgc.xcreds")
